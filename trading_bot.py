...
# Fungsi untuk menghentikan bot dalam keadaan darurat
def emergency_stop():
    send_telegram_message("⚠️ *Bot dihentikan karena error besar!*")
    logging.error("Bot dihentikan karena error besar!")
    sys.exit(1)  # Menghentikan eksekusi bot
